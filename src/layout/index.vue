<template>
  ...
  >
	...
	<!-- 自定义页签-样式 -->
	<template v-slot:tab-title="{ title, item }">
		<span>
			{{ title }}
		</span>
	</template>
	<!-- 自定义页签-右键菜单 -->
	<template v-slot:context-menu="{ tabKey, item }">
		<el-dropdown-item command="reload"><i class="el-icon-refresh"></i>&nbsp;刷新页面</el-dropdown-item>
		<el-dropdown-item command="other"><i class="el-icon-close"></i>&nbsp;关闭其他</el-dropdown-item>
	</template>
	<!-- 自定义页签-最右边下拉菜单 -->
	<template v-slot:dropdown="{ active, refresh }">
		<el-dropdown-item command="reload"><i class="el-icon-refresh"></i>&nbsp;刷新页面</el-dropdown-item>
		<el-dropdown-item command="other"><i class="el-icon-close"></i>&nbsp;关闭其他</el-dropdown-item>
	</template>
  </ele-pro-layout>
