<template>
	<el-card shadow="never" :body-style="CardBodyStyle+';'" class="workplace-table-card">
		<template v-slot:header>
			<span>{{ title }}</span>
			<more-icon @remove="onRemove" @edit="onEdit" />
		</template>
		<el-scrollbar :style="ScrollbarHeight+';'" wrapStyle="overflow-x: hidden;" viewStyle="padding: 0px 0px;">
			<el-table :data="projectList">
				...
				<el-table-column label="开始时间" prop="startDate" width="95" min-width="80" align="center"
					show-overflow-tooltip />
				<el-table-column prop="endDate" label="结束时间" width="95" min-width="80" align="center"
					show-overflow-tooltip />
				<el-table-column label="状态" width="70" min-width="60" align="center" show-overflow-tooltip>
					<template v-slot="{ row }">
						<span :class="
						  [
							'ele-text-success',
