      ...
      ['', 'login-form-right', 'login-form-left'][direction]
		...
		<el-form ref="form" size="large" :model="form" :rules="rules" class="login-form ele-bg-white"
			...
			<el-form-item prop="username">
				<el-input clearable v-model="form.username" prefix-icon="el-icon-user"
					:placeholder="$t('login.username')" />
			</el-form-item>
			<el-form-item prop="password">
				<el-input show-password v-model="form.password" prefix-icon="el-icon-lock"
					:placeholder="$t('login.password')" />
			</el-form-item>
			<el-form-item prop="captchaCode">
				<div class="login-input-group">
					<el-input clearable v-model="form.captchaCode" prefix-icon="el-icon-_vercode" :placeholder="$t('login.code')" />
					<div v-html="captchaImg" v-if="captchaImg" class="login-captcha" @click="changeCaptcha" />
				</div>
			</el-form-item>
			<div class="el-form-item">
				...
				<el-link type="info" :underline="false" class="ele-pull-right" @click="$router.push('/forget')">
					忘记密码
				</el-link>
			</div>
			<div class="el-form-item">
		...
		<div class="login-copyright">
			copyright © 2022 四川墨汇电科信息技术有限公司 all rights reserved.
		</div>
		<!-- 多语言切换 -->
	...
	export default {
		...
		methods: {
			...
			changeCaptcha() {
				getCaptcha()
					.then((data) => {
						this.captchaImg = data.codeImg;
						this.$set(this.form,'captchaCode', '');
						this.$set(this.form,'captchaKey', data.key);
