<template>
  <el-card shadow="never" header="底部地图">
...
<script>
  ...
  import { MAP_Webjs_Key } from '@/config/setting';
      ...
      renderLocationMap() {
        AMapLoader.load({
          ...
          .then((AMap) => {
            ...
            const option = {
              zoom: 13, // 初缩放级别
              center: [119.346084, 36.511215 + 0.005] // 初始中心点
            };
            if (this.darkMode) {
            ...
            const infoWindow = new AMap.InfoWindow({
              content: `
            <div style="color: #333;">
              <div style="padding: 5px;font-size: 16px;">电饭锅多喝点</div>
              <div style="padding: 0 5px;">地址: xxx222号</div>
              <div style="padding: 0 5px;">电话: xxxxw</div>
            </div>
            <a
              style="padding: 8px 5px 0;text-decoration: none;display: inline-block;"
              href="//uri.amap.com/marker?position=114.346084,30.511215&name=电饭锅多喝点"
